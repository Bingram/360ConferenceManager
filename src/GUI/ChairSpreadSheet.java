...
public class ChairSpreadSheet extends JPanel {
    private static final long serialVersionUID = 1L;
    private boolean DEBUG = false;
    public ArrayList<Submission> list;
    private JFrame my_popup;
    private static Chair my_chair;

    public ChairSpreadSheet(JFrame popup,Chair the_chair) {
        super(new GridLayout(1, 0));
        my_chair = the_chair;
        my_popup=popup;
        String[] columnNames = { "Paper Title", "Author", "Email",
                "Assigned to", "Recommendation Status", "Deadline" };
        list = the_chair.getPapers();
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            data[i][3] = new String(list.get(i).getSubChair().getName());

            data[i][4] = list.get(i).checkPaperStatus();
    ...
    private static void createAndShowGUI() {
        ...
        ChairSpreadSheet newContentPane = new ChairSpreadSheet(frame,my_chair);
